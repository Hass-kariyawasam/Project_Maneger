...
export default function App() {
  ...
  // Filter FIx: Match profile.role OR profile.username
  const visibleTasks = tasks.filter(t => {
    if (t.isPrivate && t.createdBy !== profile?.username) return false;
    const isMyTask = t.assignee === profile.role || t.assignee === "All" || t.createdBy === profile.username;
    const mMatch = taskFilter === "All" || (taskFilter === "MY_TASKS" && isMyTask);
  ...
  if (!authReady) return (
    <div style={{background:"#030503",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Share Tech Mono',monospace",color:"#00ff88"}}>
      <style>{`
        ...
        .glitch-text { animation: glitch 0.2s infinite; font-weight: bold; }
        ...
        .glow-logo { animation: pulse-glow 1.5s infinite; font-size: 80px; margin-bottom: 20px; }
      `}</style>
      <div style={{textAlign:"center"}}>
        <div className="glow-logo">⬡</div>
        <div className="glitch-text" style={{fontSize:24,letterSpacing:4, color:"#ffffff"}}>INITIALIZING SYSTEM...</div>
        <div style={{fontSize:14,color:"#00ff88",marginTop:16,letterSpacing:2}}>ESTABLISHING SECURE CONNECTION</div>
      </div>
    </div>
  );
    ...
    <div style={{background:"#030503",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"'Share Tech Mono',monospace",padding:20}}>
      ...
      <div style={{width:"100%",maxWidth:450}}>
        ...
        <div style={{textAlign:"center",marginBottom:30}}>
          ...
          <div style={{fontSize:13,color:"#00ff88",marginTop:10,letterSpacing:2}}>Duration: 13 Weeks (91 Days)</div>
        </div>
          ...
          <div key={task.fsId||task.id} style={{
            ...
            <div style={{display:"flex",alignItems:"flex-start",gap:14}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                {/* Bangla comment for task metadata */}
                {/* টাস্কের তথ্য (Task info) */}
