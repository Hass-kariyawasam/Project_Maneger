  ...
  if (!authReady) return (
    <div style={{background:"#060c06",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Share Tech Mono',monospace",color:"#00ff88"}}>
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:16,letterSpacing:3, color:"#ffffff"}}>TEAM WORKSPACE LOADING...</div>
    ...
    <div style={{background:"#060c06",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"'Share Tech Mono',monospace",padding:20}}>
      <div style={{width:"100%",maxWidth:380}}>
        ...
        <div style={{textAlign:"center",marginBottom:28}}>
          ...
          <div style={{fontSize:10,color:"#ffffff66",marginTop:6,letterSpacing:1}}>Developed by HassKariyawasam</div>
        </div>
                      ...
                      <div style={{display:"flex",alignItems:"flex-start",gap:10}}>
                        ...
                        <div style={{flex:1,minWidth:0}}>
                          ...
                          {task.note&&editNote!==(task.fsId||task.id)&&(
                            <div style={{marginTop:6,fontSize:11,color:"#00ccff",background:"#00ccff11",borderLeft:"3px solid #00ccff44",padding:"4px 8px",borderRadius:"0 6px 6px 0"}}>
                              📝 {task.note}
                            </div>
                          )}
                ...
                return (
                  <div key={msg.id} style={{display:"flex",flexDirection:isMe?"row-reverse":"row",gap:8,alignItems:"flex-end"}}>
                    ...
                    <div style={{maxWidth:"75%"}}>
                      {!isMe&&<div style={{fontSize:9,color:msg.color||"#00ff88",marginBottom:4,letterSpacing:1}}>{msg.user}</div>}
        ...
        {activeTab === "data" && (
          <div style={{padding:16}}>
            ...
            <div style={{background:"#0a140a",border:"1px solid #00ff8833",borderRadius:10,padding:16,marginBottom:16}}>
              <p style={{fontSize:12,color:"#00ff8588",marginBottom:14, lineHeight: 1.5}}>Click the button below to add the default project tasks into the database. You only need to do this once.</p>
